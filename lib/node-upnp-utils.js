...
var UPnPUtils = function() {
	...
	this.msearch_timer_id = 0;
	this.check_expiration_timer_id = 0;
...
UPnPUtils.prototype._startMsearch = function(callback) {
	...
	(function send() {
		this._sendMsearch(() => {
			num ++;
			if(num < num_max) {
				this.msearch_timer_id = setTimeout(() => {
					send.call(this);
...
UPnPUtils.prototype._startCheckExpiration = function() {
	...
	this.check_expiration_timer_id = setTimeout(() => {
		this._startCheckExpiration();
	}, 1000);
};

UPnPUtils.prototype._stopCheckExpiration = function() {
	if(this.check_expiration_timer_id) {
		clearTimeout(this.check_expiration_timer_id);
		this.check_expiration_timer_id = 0;
	}
};
...
UPnPUtils.prototype.stopDiscovery = function(callback) {
	...
	if(this.discovery_started === true) {
		if(this.msearch_timer_id > 0) {
			clearTimeout(this.msearch_timer_id);
		}
